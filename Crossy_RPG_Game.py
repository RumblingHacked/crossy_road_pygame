...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        while not is_game_over:
            ...
            # Move and draw the enemy charachter
            ...
            if player_character.detect_collision(enemy_0):
                is_game_over = True
                did_win = False
                text = font.render('Suck a Nut!', True, BLACK_COLOR)
                ...
                is_game_over = True
                did_win = True
                text = font.render('All I do is WIN!', True, BLACK_COLOR)
                self.game_screen.blit(text, (275, 350))
                pygame.display.update()
                clock.tick(1)
                break
